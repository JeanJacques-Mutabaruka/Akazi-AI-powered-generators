...
class AkaziLayoutManager:
    ...
    def _setup_footer(self):
        ...
        para.alignment = WD_ALIGN_PARAGRAPH.LEFT  # Nécessaire pour tab stops
        ...
        # ======================================================
        # 2 TAB STOPS : Centre + Droite
        # ======================================================

        tab_stops = para.paragraph_format.tab_stops
        tab_stops.clear_all()

        # Tab 1 : Centre (pour texte entreprise)
        tab_stops.add_tab_stop(
            usable_width // 2,
            WD_TAB_ALIGNMENT.CENTER
        )

        # Tab 2 : Droite (pour pagination)
        tab_stops.add_tab_stop(
            usable_width,
        ...
        # ======================================================
        # CONTENU : \t → Centre → Texte entreprise → \t → Page
        # ======================================================

        # Tab vers centre
        para.add_run("\t")

        # Texte entreprise (centré via tab stop)
